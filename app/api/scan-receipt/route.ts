...
- category: the closest of ${CATEGORIES.join(", ")}. Examples: fresh or frozen fruit and vegetables, fruit juice, salads, and prepared soups are Produce; milk, cheese, yogurt, butter, and eggs are Dairy; meat, poultry, seafood, and deli meat are Meat; bread, bagels, tortillas, and pastries are Bakery; chips, candy, cookies, soda, and other snack drinks are Snacks; paper goods, cleaning products, toiletries, and every fee or other non-food item are Household.
